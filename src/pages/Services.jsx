    ...
    return (
        ...
        >
            ...
            <div className="services grid md:grid-cols-2 grid-cols-1 gap-5 py-10">
                <div className="service flex items-center gap-10 p-10 rounded-2xl text-balance shadow-lg hover:scale-102 hover:italic shadow-gray-500 sm:text-md text-sm">
                ...
                <div className="service flex items-center gap-10 p-10 rounded-2xl text-balance shadow-lg hover:scale-102 hover:italic shadow-gray-500">
                    <div className="icon mb-10">
